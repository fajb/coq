...
module type S = sig val register : Constrexpr.constr_expr -> unit val print : unit -> unit end
...
module Spec =
  struct
    ...
    let print  () =
      ...
      let l = List.fold_left (fun acc c -> Pp.(constr_of_spec c ++ str " " ++ acc)) (Pp.str "") !table in
